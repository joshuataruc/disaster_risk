...
if (mysqli_num_rows($username_query) > 0) {
   ...
   header("Location: admins.php");
    ...
    $insert_user = "INSERT INTO admins(fname, mname, lname, username, date_of_birth, cont_num, address, password, created_at ) VALUES ('$fname', '$midname', '$lname', '$username', '$dob', '$cont_num', '$address', '$password', '$created_at')";
